...
#ifndef WAVEUI_SWIFT_H
#define WAVEUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="WaveUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6WaveUI18ActivityItemSource")
...
SWIFT_CLASS("_TtC6WaveUI9Animation")
...
@interface Animation (SWIFT_EXTENSION(WaveUI)) <UIViewControllerTransitioningDelegate>
...
SWIFT_CLASS("_TtC6WaveUI21BarCodeTextFieldLabel")
@interface BarCodeTextFieldLabel : UIView
...
SWIFT_CLASS("_TtC6WaveUI13BaseTextField")
...
SWIFT_CLASS("_TtC6WaveUI34BottomSheetTransitioningController")
@interface BottomSheetTransitioningController : NSObject <UIViewControllerTransitioningDelegate>
...
SWIFT_CLASS("_TtC6WaveUI30InteractiveTransitionAnimation")
...
SWIFT_CLASS("_TtC6WaveUI32InterruptibleTransitionAnimation") SWIFT_AVAILABILITY(tvos,introduced=10.0) SWIFT_AVAILABILITY(ios,introduced=10.0)
...
SWIFT_CLASS("_TtC6WaveUI27NavigationAnimationDelegate")
...
@interface NavigationAnimationDelegate (SWIFT_EXTENSION(WaveUI)) <UIGestureRecognizerDelegate>
...
@interface NavigationAnimationDelegate (SWIFT_EXTENSION(WaveUI)) <UINavigationControllerDelegate>
...
SWIFT_CLASS("_TtC6WaveUI20NavigationController")
...
SWIFT_CLASS("_TtC6WaveUI24NomoNavigationController")
@interface NomoNavigationController : NavigationController
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithRootViewController:(UIViewController * _Nonnull)rootViewController OBJC_DESIGNATED_INITIALIZER;
- (void)viewDidLoad;
@end
...
SWIFT_CLASS("_TtC6WaveUI25PageCoordinatorDataSource")
...
/// animation.
SWIFT_CLASS("_TtC6WaveUI25StaticTransitionAnimation")
...
SWIFT_CLASS("_TtC6WaveUI23TabBarAnimationDelegate")
...
@interface TabBarAnimationDelegate (SWIFT_EXTENSION(WaveUI)) <UITabBarControllerDelegate>
